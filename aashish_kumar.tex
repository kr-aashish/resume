...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Modeled project, donor \& payment endpoints with \textbf{JWT} auth, Joi validation, and S3 presigned URLs for media uploads}
            \resumeItem{Penned \textbf{UTs} and \textbf{acceptance test} suites for the endpoints, maintaining \textbf{90\%+} code coverage, with Jest and SuperTest}
