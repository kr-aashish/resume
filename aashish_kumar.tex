...
\section{Technical Skills}
 ...
 \small{
  ...
  \vspace{0.5em}
  \textbf{Markup/Query Languages} \\
  HTML5 • CSS3 • T‐SQL • pgSQL
  
  \vspace{0.5em}
  \textbf{Frameworks \& ORMs} \\
  Spring Boot • Gin • Node.js • Flask \\
  jOOQ • Mongoose • Prisma • Gorm
  
  \vspace{0.5em}
  \textbf{Libraries} \\
  React.js • Jest • Joi • SuperTest • Colly
 ...
 \small{
  ...
  Lambda • SNS • SQS • SES • ECS \\
  Docker • IIS • Nginx • GitHub Actions \\
  Azure CI/CD • Deployment Groups
